function [BestPartitionSeed,BestProbabilityPartitionSeed]=test_GeneratePartitionSeed_withMiss(TypeModel,Vectors,HypParam,n1,n2,HammingDistance,MissMatr,varargin)
% test_GeneratePartitionSeed finds the maximum probability partition for a
...
[Prphi1_S,Prphi2_S]=test_ComputeProbabilityOfPartitions_withMiss(TypeModel,Vectors,HypParam,InitialPartition,MissMatr,'NoNormalize');
